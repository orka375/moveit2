...
bool moveit_task_constructor_msgs__msg__trajectory_execution_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._trajectory_execution_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 59) == 0);
    assert(strncmp("TrajectoryExecutionInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
