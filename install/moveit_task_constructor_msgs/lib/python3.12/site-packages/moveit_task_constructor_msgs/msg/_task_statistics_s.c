...
bool moveit_task_constructor_msgs__msg__task_statistics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._task_statistics", (char *)PyUnicode_1BYTE_DATA(module_attr), 49) == 0);
    assert(strncmp("TaskStatistics", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
