...
moveit_msgs__srv__DeleteRobotStateFromWarehouse_Request__create(void)
{
...
moveit_msgs__srv__DeleteRobotStateFromWarehouse_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
moveit_msgs__srv__DeleteRobotStateFromWarehouse_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
