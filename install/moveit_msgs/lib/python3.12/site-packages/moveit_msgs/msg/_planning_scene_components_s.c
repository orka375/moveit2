...
bool moveit_msgs__msg__planning_scene_components__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._planning_scene_components", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("PlanningSceneComponents", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
