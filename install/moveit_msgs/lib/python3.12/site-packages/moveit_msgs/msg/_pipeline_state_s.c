...
bool moveit_msgs__msg__pipeline_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._pipeline_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("PipelineState", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
