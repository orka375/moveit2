...
bool moveit_msgs__msg__object_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._object_color", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("ObjectColor", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
