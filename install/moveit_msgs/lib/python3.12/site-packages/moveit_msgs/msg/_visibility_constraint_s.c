...
bool moveit_msgs__msg__visibility_constraint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._visibility_constraint", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("VisibilityConstraint", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
