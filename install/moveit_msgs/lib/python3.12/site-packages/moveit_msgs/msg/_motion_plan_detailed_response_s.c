...
bool moveit_msgs__msg__motion_plan_detailed_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._motion_plan_detailed_response", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("MotionPlanDetailedResponse", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
