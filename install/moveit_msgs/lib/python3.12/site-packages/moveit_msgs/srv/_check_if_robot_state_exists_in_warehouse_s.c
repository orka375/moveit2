...
bool moveit_msgs__srv__check_if_robot_state_exists_in_warehouse__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._check_if_robot_state_exists_in_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 57) == 0);
    assert(strncmp("CheckIfRobotStateExistsInWarehouse_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 42) == 0);
...
bool moveit_msgs__srv__check_if_robot_state_exists_in_warehouse__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._check_if_robot_state_exists_in_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 57) == 0);
    assert(strncmp("CheckIfRobotStateExistsInWarehouse_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 43) == 0);
...
bool moveit_msgs__srv__check_if_robot_state_exists_in_warehouse__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._check_if_robot_state_exists_in_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 57) == 0);
    assert(strncmp("CheckIfRobotStateExistsInWarehouse_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 40) == 0);
