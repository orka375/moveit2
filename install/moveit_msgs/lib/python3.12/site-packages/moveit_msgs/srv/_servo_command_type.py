...
class Metaclass_ServoCommandType_Event(type):
    """Metaclass of message 'ServoCommandType_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__servo_command_type__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__servo_command_type__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__servo_command_type__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__servo_command_type__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__servo_command_type__event
...
class ServoCommandType_Event(metaclass=Metaclass_ServoCommandType_Event):
    """Message class 'ServoCommandType_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<moveit_msgs/ServoCommandType_Request, 1>',
        'response': 'sequence<moveit_msgs/ServoCommandType_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ServoCommandType_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ServoCommandType_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ServoCommandType_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ServoCommandType_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ServoCommandType_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ServoCommandType_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ServoCommandType_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ServoCommandType_Response'"
...
class Metaclass_ServoCommandType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _servo_command_type.Metaclass_ServoCommandType_Event._TYPE_SUPPORT is None:
                _servo_command_type.Metaclass_ServoCommandType_Event.__import_type_support__()
...
class ServoCommandType(metaclass=Metaclass_ServoCommandType):
    ...
    from moveit_msgs.srv._servo_command_type import ServoCommandType_Event as Event
