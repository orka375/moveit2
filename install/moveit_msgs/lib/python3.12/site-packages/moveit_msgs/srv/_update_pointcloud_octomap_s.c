...
bool moveit_msgs__srv__update_pointcloud_octomap__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._update_pointcloud_octomap", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("UpdatePointcloudOctomap_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 31) == 0);
...
bool moveit_msgs__srv__update_pointcloud_octomap__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._update_pointcloud_octomap", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("UpdatePointcloudOctomap_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 32) == 0);
...
bool moveit_msgs__srv__update_pointcloud_octomap__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._update_pointcloud_octomap", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("UpdatePointcloudOctomap_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 29) == 0);
