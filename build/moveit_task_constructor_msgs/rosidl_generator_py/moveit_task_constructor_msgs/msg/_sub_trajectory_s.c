...
bool moveit_task_constructor_msgs__msg__sub_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._sub_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 48) == 0);
    assert(strncmp("SubTrajectory", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
