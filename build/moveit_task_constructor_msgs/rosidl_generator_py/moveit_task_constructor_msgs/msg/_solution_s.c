...
bool moveit_task_constructor_msgs__msg__solution__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._solution", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("Solution", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);
