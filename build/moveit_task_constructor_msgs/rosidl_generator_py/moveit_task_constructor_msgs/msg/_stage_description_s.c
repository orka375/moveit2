...
bool moveit_task_constructor_msgs__msg__stage_description__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._stage_description", (char *)PyUnicode_1BYTE_DATA(module_attr), 51) == 0);
    assert(strncmp("StageDescription", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
