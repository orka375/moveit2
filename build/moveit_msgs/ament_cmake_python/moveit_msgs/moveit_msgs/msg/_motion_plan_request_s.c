...
bool moveit_msgs__msg__motion_plan_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._motion_plan_request", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("MotionPlanRequest", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
