...
bool moveit_msgs__msg__generic_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._generic_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("GenericTrajectory", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
