...
bool moveit_msgs__msg__constraints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._constraints", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("Constraints", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
