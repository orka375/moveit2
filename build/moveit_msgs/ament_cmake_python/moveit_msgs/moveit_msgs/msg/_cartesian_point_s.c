...
bool moveit_msgs__msg__cartesian_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._cartesian_point", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("CartesianPoint", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
