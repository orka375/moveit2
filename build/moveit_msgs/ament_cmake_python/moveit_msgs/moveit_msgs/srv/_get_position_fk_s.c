...
bool moveit_msgs__srv__get_position_fk__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_position_fk", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("GetPositionFK_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
...
bool moveit_msgs__srv__get_position_fk__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_position_fk", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("GetPositionFK_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
...
bool moveit_msgs__srv__get_position_fk__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_position_fk", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("GetPositionFK_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
