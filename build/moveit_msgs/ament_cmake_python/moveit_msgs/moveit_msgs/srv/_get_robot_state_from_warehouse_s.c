...
bool moveit_msgs__srv__get_robot_state_from_warehouse__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_robot_state_from_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("GetRobotStateFromWarehouse_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 34) == 0);
...
bool moveit_msgs__srv__get_robot_state_from_warehouse__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_robot_state_from_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("GetRobotStateFromWarehouse_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 35) == 0);
...
bool moveit_msgs__srv__get_robot_state_from_warehouse__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_robot_state_from_warehouse", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("GetRobotStateFromWarehouse_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 32) == 0);
