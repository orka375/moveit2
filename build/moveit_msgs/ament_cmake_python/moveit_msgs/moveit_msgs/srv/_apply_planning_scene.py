...
class Metaclass_ApplyPlanningScene_Event(type):
    """Metaclass of message 'ApplyPlanningScene_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__apply_planning_scene__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__apply_planning_scene__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__apply_planning_scene__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__apply_planning_scene__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__apply_planning_scene__event
...
class ApplyPlanningScene_Event(metaclass=Metaclass_ApplyPlanningScene_Event):
    """Message class 'ApplyPlanningScene_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<moveit_msgs/ApplyPlanningScene_Request, 1>',
        'response': 'sequence<moveit_msgs/ApplyPlanningScene_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ApplyPlanningScene_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ApplyPlanningScene_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ApplyPlanningScene_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ApplyPlanningScene_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ApplyPlanningScene_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ApplyPlanningScene_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ApplyPlanningScene_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ApplyPlanningScene_Response'"
...
class Metaclass_ApplyPlanningScene(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _apply_planning_scene.Metaclass_ApplyPlanningScene_Event._TYPE_SUPPORT is None:
                _apply_planning_scene.Metaclass_ApplyPlanningScene_Event.__import_type_support__()
...
class ApplyPlanningScene(metaclass=Metaclass_ApplyPlanningScene):
    ...
    from moveit_msgs.srv._apply_planning_scene import ApplyPlanningScene_Event as Event
