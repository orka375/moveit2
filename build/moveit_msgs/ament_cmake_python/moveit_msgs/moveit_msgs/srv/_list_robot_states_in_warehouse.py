...
class Metaclass_ListRobotStatesInWarehouse_Event(type):
    """Metaclass of message 'ListRobotStatesInWarehouse_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_robot_states_in_warehouse__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_robot_states_in_warehouse__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_robot_states_in_warehouse__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_robot_states_in_warehouse__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_robot_states_in_warehouse__event
...
class ListRobotStatesInWarehouse_Event(metaclass=Metaclass_ListRobotStatesInWarehouse_Event):
    """Message class 'ListRobotStatesInWarehouse_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<moveit_msgs/ListRobotStatesInWarehouse_Request, 1>',
        'response': 'sequence<moveit_msgs/ListRobotStatesInWarehouse_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ListRobotStatesInWarehouse_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'ListRobotStatesInWarehouse_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ListRobotStatesInWarehouse_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListRobotStatesInWarehouse_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListRobotStatesInWarehouse_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from moveit_msgs.srv import ListRobotStatesInWarehouse_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListRobotStatesInWarehouse_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListRobotStatesInWarehouse_Response'"
...
class Metaclass_ListRobotStatesInWarehouse(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_robot_states_in_warehouse.Metaclass_ListRobotStatesInWarehouse_Event._TYPE_SUPPORT is None:
                _list_robot_states_in_warehouse.Metaclass_ListRobotStatesInWarehouse_Event.__import_type_support__()
...
class ListRobotStatesInWarehouse(metaclass=Metaclass_ListRobotStatesInWarehouse):
    ...
    from moveit_msgs.srv._list_robot_states_in_warehouse import ListRobotStatesInWarehouse_Event as Event
