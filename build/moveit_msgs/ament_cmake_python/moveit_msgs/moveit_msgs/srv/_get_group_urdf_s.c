...
bool moveit_msgs__srv__get_group_urdf__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_group_urdf", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetGroupUrdf_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
...
bool moveit_msgs__srv__get_group_urdf__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_group_urdf", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetGroupUrdf_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
...
bool moveit_msgs__srv__get_group_urdf__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._get_group_urdf", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetGroupUrdf_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
