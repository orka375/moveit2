...
class LoadMap_Event(metaclass=Metaclass_LoadMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<moveit_msgs/LoadMap_Request, 1>',
        'response': 'sequence<moveit_msgs/LoadMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'LoadMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'LoadMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from moveit_msgs.srv import LoadMap_Request
    ...
    def response(self, value):
        if self._check_fields:
            from moveit_msgs.srv import LoadMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class LoadMap(metaclass=Metaclass_LoadMap):
    ...
    from moveit_msgs.srv._load_map import LoadMap_Event as Event
