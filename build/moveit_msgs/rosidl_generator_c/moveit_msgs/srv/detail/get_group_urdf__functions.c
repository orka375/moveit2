...
moveit_msgs__srv__GetGroupUrdf_Request__create(void)
{
...
moveit_msgs__srv__GetGroupUrdf_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
moveit_msgs__srv__GetGroupUrdf_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
