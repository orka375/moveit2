...
moveit_msgs__srv__ListRobotStatesInWarehouse_Request__create(void)
{
...
moveit_msgs__srv__ListRobotStatesInWarehouse_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
moveit_msgs__srv__ListRobotStatesInWarehouse_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
