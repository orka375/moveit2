...
static const _GraspPlanning_Event_type_support_symbol_names_t _GraspPlanning_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, GraspPlanning_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, GraspPlanning_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, GraspPlanning_Event)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::GraspPlanning_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GraspPlanning_service_type_support_handle = {
  ...
  &GraspPlanning_Request_message_type_support_handle,
  &GraspPlanning_Response_message_type_support_handle,
  &GraspPlanning_Event_message_type_support_handle,
