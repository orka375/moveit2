...
static const _SaveGeometryToFile_Event_type_support_symbol_names_t _SaveGeometryToFile_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, SaveGeometryToFile_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SaveGeometryToFile_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, SaveGeometryToFile_Event)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::SaveGeometryToFile_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SaveGeometryToFile_service_type_support_handle = {
  ...
  &SaveGeometryToFile_Request_message_type_support_handle,
  &SaveGeometryToFile_Response_message_type_support_handle,
  &SaveGeometryToFile_Event_message_type_support_handle,
