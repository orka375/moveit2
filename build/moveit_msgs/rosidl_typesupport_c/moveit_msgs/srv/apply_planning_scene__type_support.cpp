...
static const _ApplyPlanningScene_Event_type_support_symbol_names_t _ApplyPlanningScene_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, ApplyPlanningScene_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ApplyPlanningScene_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, ApplyPlanningScene_Event)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::ApplyPlanningScene_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ApplyPlanningScene_service_type_support_handle = {
  ...
  &ApplyPlanningScene_Request_message_type_support_handle,
  &ApplyPlanningScene_Response_message_type_support_handle,
  &ApplyPlanningScene_Event_message_type_support_handle,
