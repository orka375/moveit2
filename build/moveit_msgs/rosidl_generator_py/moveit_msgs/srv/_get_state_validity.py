...
class Metaclass_GetStateValidity_Event(type):
    """Metaclass of message 'GetStateValidity_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_state_validity__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_state_validity__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_state_validity__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_state_validity__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_state_validity__event
...
class GetStateValidity_Event(metaclass=Metaclass_GetStateValidity_Event):
    """Message class 'GetStateValidity_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<moveit_msgs/GetStateValidity_Request, 1>',
        'response': 'sequence<moveit_msgs/GetStateValidity_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'GetStateValidity_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'srv'], 'GetStateValidity_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from moveit_msgs.srv import GetStateValidity_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetStateValidity_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetStateValidity_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from moveit_msgs.srv import GetStateValidity_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetStateValidity_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetStateValidity_Response'"
...
class Metaclass_GetStateValidity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_state_validity.Metaclass_GetStateValidity_Event._TYPE_SUPPORT is None:
                _get_state_validity.Metaclass_GetStateValidity_Event.__import_type_support__()
...
class GetStateValidity(metaclass=Metaclass_GetStateValidity):
    ...
    from moveit_msgs.srv._get_state_validity import GetStateValidity_Event as Event
