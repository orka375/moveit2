...
bool moveit_msgs__srv__servo_command_type__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._servo_command_type", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("ServoCommandType_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool moveit_msgs__srv__servo_command_type__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._servo_command_type", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("ServoCommandType_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool moveit_msgs__srv__servo_command_type__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("moveit_msgs.srv._servo_command_type", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("ServoCommandType_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
