...
bool moveit_msgs__msg__cost_source__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._cost_source", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("CostSource", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
