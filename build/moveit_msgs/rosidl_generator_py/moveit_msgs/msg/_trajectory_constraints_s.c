...
bool moveit_msgs__msg__trajectory_constraints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._trajectory_constraints", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("TrajectoryConstraints", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
