...
bool moveit_msgs__msg__gripper_translation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._gripper_translation", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("GripperTranslation", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
