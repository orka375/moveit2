...
bool moveit_msgs__msg__bounding_volume__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._bounding_volume", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("BoundingVolume", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
