...
bool moveit_msgs__msg__kinematic_solver_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._kinematic_solver_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("KinematicSolverInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
