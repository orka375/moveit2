...
bool moveit_msgs__msg__planning_options__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._planning_options", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("PlanningOptions", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
