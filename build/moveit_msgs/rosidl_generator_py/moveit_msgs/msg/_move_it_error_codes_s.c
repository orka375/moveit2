...
bool moveit_msgs__msg__move_it_error_codes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._move_it_error_codes", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("MoveItErrorCodes", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
