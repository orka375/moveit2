...
bool moveit_msgs__msg__attached_collision_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._attached_collision_object", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("AttachedCollisionObject", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
