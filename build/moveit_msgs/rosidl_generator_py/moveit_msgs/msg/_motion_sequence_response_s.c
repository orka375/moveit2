...
bool moveit_msgs__msg__motion_sequence_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._motion_sequence_response", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("MotionSequenceResponse", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
