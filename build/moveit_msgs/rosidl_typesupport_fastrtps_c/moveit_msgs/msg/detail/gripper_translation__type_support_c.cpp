  ...
  moveit_msgs__msg__GripperTranslation * ros_message)
{
  // Field name: direction
  {
    cdr_deserialize_geometry_msgs__msg__Vector3Stamped(cdr, &ros_message->direction);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__GripperTranslation * ros_message = static_cast<const moveit_msgs__msg__GripperTranslation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__GripperTranslation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__GripperTranslation * ros_message = static_cast<moveit_msgs__msg__GripperTranslation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__GripperTranslation(cdr, ros_message);
}
