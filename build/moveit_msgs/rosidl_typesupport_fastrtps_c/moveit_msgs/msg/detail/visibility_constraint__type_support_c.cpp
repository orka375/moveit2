  ...
  moveit_msgs__msg__VisibilityConstraint * ros_message)
{
  ...
  // Field name: sensor_pose
  {
    cdr_deserialize_geometry_msgs__msg__PoseStamped(cdr, &ros_message->sensor_pose);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__VisibilityConstraint * ros_message = static_cast<const moveit_msgs__msg__VisibilityConstraint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__VisibilityConstraint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__VisibilityConstraint * ros_message = static_cast<moveit_msgs__msg__VisibilityConstraint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__VisibilityConstraint(cdr, ros_message);
}
