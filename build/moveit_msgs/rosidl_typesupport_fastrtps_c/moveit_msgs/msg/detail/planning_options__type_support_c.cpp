  ...
  moveit_msgs__msg__PlanningOptions * ros_message)
{
  // Field name: planning_scene_diff
  {
    cdr_deserialize_moveit_msgs__msg__PlanningScene(cdr, &ros_message->planning_scene_diff);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__PlanningOptions * ros_message = static_cast<const moveit_msgs__msg__PlanningOptions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__PlanningOptions(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__PlanningOptions * ros_message = static_cast<moveit_msgs__msg__PlanningOptions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__PlanningOptions(cdr, ros_message);
}
