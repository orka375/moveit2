  ...
  moveit_msgs__msg__MotionSequenceItem * ros_message)
{
  // Field name: req
  {
    cdr_deserialize_moveit_msgs__msg__MotionPlanRequest(cdr, &ros_message->req);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__MotionSequenceItem * ros_message = static_cast<const moveit_msgs__msg__MotionSequenceItem *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__MotionSequenceItem(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__MotionSequenceItem * ros_message = static_cast<moveit_msgs__msg__MotionSequenceItem *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__MotionSequenceItem(cdr, ros_message);
}
