  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__MotionPlanResponse * ros_message = static_cast<const moveit_msgs__msg__MotionPlanResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__MotionPlanResponse(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__MotionPlanResponse * ros_message = static_cast<moveit_msgs__msg__MotionPlanResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__MotionPlanResponse(cdr, ros_message);
}
