...
template<>
inline const char * data_type<moveit_msgs::action::MoveGroupSequence>()
{
  return "moveit_msgs::action::MoveGroupSequence";
}

template<>
inline const char * name<moveit_msgs::action::MoveGroupSequence>()
{
  return "moveit_msgs/action/MoveGroupSequence";
}
