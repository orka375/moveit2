...
template<>
inline const char * data_type<moveit_msgs::action::HybridPlanner>()
{
  return "moveit_msgs::action::HybridPlanner";
}

template<>
inline const char * name<moveit_msgs::action::HybridPlanner>()
{
  return "moveit_msgs/action/HybridPlanner";
}
