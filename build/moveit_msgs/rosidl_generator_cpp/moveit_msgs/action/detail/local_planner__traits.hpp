...
template<>
inline const char * data_type<moveit_msgs::action::LocalPlanner>()
{
  return "moveit_msgs::action::LocalPlanner";
}

template<>
inline const char * name<moveit_msgs::action::LocalPlanner>()
{
  return "moveit_msgs/action/LocalPlanner";
}
